...
--
-- Host: localhost
-- Generation Time: Nov 25, 2023 at 11:33 PM
...
--
-- Table structure for table `wp_appstore_categories`
--

CREATE TABLE IF NOT EXISTS `wp_appstore_categories` (
...
CREATE TABLE IF NOT EXISTS `wp_appstore_contents` (
...
CREATE TABLE IF NOT EXISTS `wp_appstore_hits` (
...
CREATE TABLE IF NOT EXISTS `wp_appstore_license_keys` (
...
CREATE TABLE IF NOT EXISTS `wp_appstore_releases` (
...
CREATE TABLE IF NOT EXISTS `wp_appstore_sales` (
...
--
-- Table structure for table `wp_appstore_tags`
--

CREATE TABLE IF NOT EXISTS `wp_appstore_tags` (
...
--
-- Table structure for table `wp_appstore_tag_relations`
--

CREATE TABLE IF NOT EXISTS `wp_appstore_tag_relations` (
