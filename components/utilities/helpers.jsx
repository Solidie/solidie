...
export function getSocialIcon(url) {
	...
	const class_name = 's-icon-' + brand;
	const final_class = `s-icon ${icons[class_name] ? class_name : 's-icon-anchor'}`.classNames();
...
export function formatDate( date_string, format = window.Solidie.date_format ) {
