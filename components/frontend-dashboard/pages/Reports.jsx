    ...
    <div className="flex flex-col w-full h-full space-y-5">
      ...
      <div className="max-h-max w-full flex flex-col lg:flex-row justify-between gap-5">
        <div className="flex flex-col w-full lg:w-[60%]">
          ...
          <div
            ref={leftref}
            className="py-2 flex items-center w-full sm:px-4 bg-lightest-version rounded-xl shadow-lg"
          >
        ...
        <div className="flex flex-col w-full lg:w-[37%]">
          ...
          <div
            ref={rightref}
            className="h-max w-full px-4 bg-lightest-version rounded-xl shadow-lg"
          >
