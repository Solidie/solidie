...
const Select = React.forwardRef(({ disableItemsList, defaultValue, ariaLabel, itemsList }, forwardRef,) => {
  return (
    <SelectPrimitive.Root defaultValue={defaultValue}>
      ...
      <SelectPrimitive.Content className="shadow-lg shadow-tertiary/60 rounded-lg border-2 border-tertiary">
