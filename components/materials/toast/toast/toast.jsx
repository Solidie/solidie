...
const colors = {
    success: window.Solidie.colors['secondary'],
    warning: window.Solidie.colors['warning'],
    error: window.Solidie.colors['error']
};
...
export function ToastWrapper(props) {
    ...
    return (
        <ContextToast.Provider value={{ addToast, ajaxToast }}>
            ...
            {(state.toasts.length && (
                <div
                    data-solidie-selector="toast-wrapper"
                    ref={ref}
                    className={
