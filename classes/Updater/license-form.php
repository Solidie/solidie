<?php 
	...
	$class_name    = $license ? ( $license['activated'] ? 'solidie-license-is-valid' : 'solidie-license-is-invalid' ) : '';
	$field_value   = $license ? ( $license['license_key'] ?? '' ) : '';
?>

<div class="solidie-license-window">
    <div class="solidie-license-card">
        <div>
        ...
        <?php if ( $license !== null ) : ?>
            <?php if ( $license['activated'] == true ) : ?>
                <div class="solidie-license-alert-success">
                    <div class="solidie-license-alert-icon">
                    ...
                    <div class="solidie-license-alert-title">
                        Congratulation
                    </div>
                    <div class="solidie-license-alert-message">
            ...
            <?php else : ?>
                <div class="solidie-license-alert-error">
                    <div class="solidie-license-alert-icon">
            ...
            <?php if ( $license !== null && $license['activated'] ) : ?>
                <div class="solidie-license-fieldset">
                    <div class="solidie-license-fieldset-label">
                        Licensed To:
                    </div>
                    <div class="solidie-license-fieldset-content">
        ...
        <div id="solidie-license-key-form">
            <div class="solidie-license-fieldset">
                <div class="solidie-license-fieldset-content">
                    ...
                    <div class="solidie-license-help-text">If you have a <?php echo $product_title; ?> license, please paste your code here. Or purchase one.</div>
                </div>
            </div>

            <div class="solidie-license-actions">
