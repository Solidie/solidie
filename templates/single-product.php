        ...
        <div class="flex flex-col justify-center items-center gap-5">
            ...
            <div class="relative mt-8 max-w-2xl mx-auto px-4 pb-8 sm:mt-12 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-0">
                ...
                <div class="relative space-y-6 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-2">
                    <div
                        class="flex flex-col justify-between items-center bg-brand-tertiary pt-6 px-6 pb-3 rounded-3xl lg:px-6 lg:py-8">
                        <div class="w-full">
                        ...
                        <a href="#"
                            class="bg-tertiary text-brand-tertiary hover:text-tertiary hover:bg-tertiary/5 mt-6 w-full inline-block py-2 px-8 border border-transparent rounded-full shadow-sm text-center text-sm font-medium sm:mt-0 sm:w-auto lg:mt-6 lg:w-full hover:underline hover:decoration-dashed">Get
                            Started</a>
                    </div>

                    <div
                        class="flex flex-col justify-between z-50 bg-tertiary lg:scale-105 shadow-xl lg:relative lg:bottom-3 px-6 py-3 rounded-3xl lg:px-14 lg:py-8">
                        <div class="">
                            <div>
                        ...
                        <a href="#"
                            class="font-bold bg-brand-tertiary text-tertiary mt-6 w-full inline-block py-2 px-8 border border-transparent rounded-full shadow-sm text-center text-sm sm:mt-0 sm:w-auto lg:mt-6 lg:w-full underline decoration-dashed">Get
                            Started</a>
                    </div>
