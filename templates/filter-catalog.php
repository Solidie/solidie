    ...
    <div class="appstore-special-catalog-wrapper max-w-screen-2xl w-full h-full py-10 px-5 flex flex-col gap-5">
        <div class="">
            <div class="text-center py-16 px-4 sm:px-6 lg:px-8">
                ...
                <p class="mt-4 max-w-xl mx-auto text-base text-gray-500">The secret to a tidy desk? Don't get rid of
                            ...
                            <fieldset>
                                ...
                                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                                    <div class="flex items-center text-base sm:text-sm">
                                        ...
                                        <label for="category-0" class="ml-3 min-w-0 flex-1 text-gray-600"> Wordpress
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="category-1" name="forms[]" value="25" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="category-1" class="ml-3 min-w-0 flex-1 text-gray-600"> Forms
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="category-2" name="ecommerce[]" value="50" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="category-2" class="ml-3 min-w-0 flex-1 text-gray-600"> eCommerce
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="category-3" name="add-ons[]" value="75" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="category-3" class="ml-3 min-w-0 flex-1 text-gray-600"> Add Ons
                                        </label>
                                    </div>
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="category-4" name="calendars[]" value="white" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="category-4" class="ml-3 min-w-0 flex-1 text-gray-600"> Calendars
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="category-5" name="interface-elements[]" value="beige" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="category-5" class="ml-3 min-w-0 flex-1 text-gray-600"> Interface
                                            Elements
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="category-6" name="news-letters[]" value="blue" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"
                                            checked>
                                        <label for="category-6" class="ml-3 min-w-0 flex-1 text-gray-600"> News letters
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="compatible-with-0" name="compatible-with[]" value="block-editor"
                                            type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="compatible-with-0" class="ml-3 min-w-0 flex-1 text-gray-600"> Block
                                            Editor
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="compatible-with-1" name="compatible-with[]" value="woocommerce"
                                            type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="compatible-with-1" class="ml-3 min-w-0 flex-1 text-gray-600">
                                            WooCommerce
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="compatible-with-2" name="compatible-with[]" value="elementor-pro"
                                            type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="compatible-with-2" class="ml-3 min-w-0 flex-1 text-gray-600">
                                            Elementor Pro
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="compatible-with-3" name="compatible-with[]" value="elementor"
                                            type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="compatible-with-3" class="ml-3 min-w-0 flex-1 text-gray-600">
                                            Elementor
                                        </label>
                                    </div>
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="compatible-with-4" name="compatible-with[]" value="bootstrap"
                                            type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="compatible-with-4" class="ml-3 min-w-0 flex-1 text-gray-600">
                                            Bootstrap
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="sales-0" name="sales[]" value="no-sales" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="sales-0" class="ml-3 min-w-0 flex-1 text-gray-600"> No Sales
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="sales-1" name="sales[]" value="low" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"
                                            checked>
                                        <label for="sales-1" class="ml-3 min-w-0 flex-1 text-gray-600"> Low </label>
                                    </div>

                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="sales-2" name="sales[]" value="medium" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="sales-2" class="ml-3 min-w-0 flex-1 text-gray-600"> Medium </label>
                                    </div>

                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="sales-3" name="sales[]" value="high" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="sales-3" class="ml-3 min-w-0 flex-1 text-gray-600"> High </label>
                                    </div>

                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="sales-4" name="sales[]" value="top-sellers" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="sales-4" class="ml-3 min-w-0 flex-1 text-gray-600"> Top Sellers
                                        </label>
                                    </div>
                            ...
                            <fieldset>
                                ...
                                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                                    <div class="flex items-center">
                                        ...
                                        <label for="show-all" class="ml-3 block text-sm text-gray-700"> Show All
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="one-star-and-higher" name="rating" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="one-star-and-higher" class="ml-3 block text-sm text-gray-700"> 1
                                    ...
                                    <div class="flex items-center">
                                        <input id="two-star-and-higher" name="rating" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="two-star-and-higher" class="ml-3 block text-sm text-gray-700"> 2
                                            Star and Higher</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="three-star-and-higher" name="rating" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="three-star-and-higher" class="ml-3 block text-sm text-gray-700"> 3
                                            Star and Higher</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="four-star-and-higher" name="rating" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="four-star-and-higher" class="ml-3 block text-sm text-gray-700"> 4
                                            Star and Higher</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="five-star-and-higher" name="rating" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="five-star-and-higher" class="ml-3 block text-sm text-gray-700"> 5
                                            Star and Higher</label>
                                    </div>
                                </div>
                            </fieldset>
                                ...
                                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                                    <div class="flex items-center">
                                        <input id="any-date" name="date-added" type="radio" checked
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="any-date" class="ml-3 block text-sm text-gray-700"> Any date
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="in-the-last-year" name="date-added" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="in-the-last-year" class="ml-3 block text-sm text-gray-700"> In the
                                            last year</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="in-the-last-month" name="date-added" type="radio"
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        <label for="in-the-last-month" class="ml-3 block text-sm text-gray-700"> In the
                                            last month</label>
                                    </div>
                                ...
                                <div class="pt-6 space-y-6 sm:pt-4 sm:space-y-4">
                                    <div class="flex items-center text-base sm:text-sm">
                                        <input id="on-sale-0" name="on-sale[]" value="true" type="checkbox"
                                            class="flex-shrink-0 h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500">
                                        <label for="on-sale-0" class="ml-3 min-w-0 flex-1 text-gray-600"> Yes
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
